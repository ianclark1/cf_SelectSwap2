...
<cfoutput>
<div class="SelectSwap #tagInstanceName# SelectSwap_#displayMode#" id="#tagInstanceName#_box" style="display:none;border-collapse:collapse;">
	<!--- All Display --->
...
<cfelse>
		<input type="button" value="&##8594;" onClick="javascript:addSelected('#tagInstanceName#');">
		<input type="button" value="&##8658;" onClick="javascript:addAll('#tagInstanceName#');"><br>
		<input type="button" value="&##8592;" onClick="javascript:removeSelected('#tagInstanceName#');">
		<input type="button" value="&##8656;" onClick="javascript:removeAll('#tagInstanceName#');">
</cfif>
	</div>
	<!--- Selected Display --->	
